...
// Readings - menu   ////  STP readings ////
app.post('/api/filter/getAllSTPHourReadingsTable', (req, res) => {
...
app.get('/api/stp-hour-readings/daily/:id/:date', (req, res) => {
